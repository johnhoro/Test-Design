...
const configData = dashboard[6].configuration;
          ...
          <section className="upload-section">
            <div className="upload">
              ...
              <div className="flex justify-end">
                <button onClick={handleUpload} className="browse-btn margin-r">
                  Cancle
                </button>
                <button className="browse-btn margin-r" onClick={addFile}>
                  Upload & Reconcile
                </button>
              </div>
            </div>
